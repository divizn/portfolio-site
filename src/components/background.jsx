...
const Background = ({ children }) => {
  ...
  return (
    ...
    >
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-b from-blue-900 to-blue-700 transition-all duration-1000 ease-in dark:from-black dark:via-neutral-950 dark:to-gray-950">
        <button
